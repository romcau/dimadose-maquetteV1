interface Props {
   ...
   *
   * Absent sur la première étape, qui n'a pas de précédente.
   */
  onBack?: () => void
}
...
export default function StepValidateBar({ validated, onValidate, onUnvalidate, nextLabel, onNext, canValidate = true, validatorLabel, onBack }: Props) {
  if (!canValidate && !validated) {
    return (
      <div className="max-w-4xl mx-auto mt-4">
        <div className="bg-slate-50 border border-slate-200 rounded-3xl px-6 py-4 flex items-center gap-3 flex-wrap">
